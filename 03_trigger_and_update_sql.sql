...
BEGIN 
	...
	SELECT  I.MusteriID,I.SiparisID,'Kazanç',        CAST(I.ToplamTutar / 1000 AS INT),'Siparisten kazanilan puan'  FROM inserted I 
...
--Faturalar Tablosuna Dinamik Olarak Tutar Çekip Vergi Oraniniyla Birlikte Ekleyen TRIGGER
GO
...
--Sepet Tutarini Dinamik Olarak Güncelleyen TRIGGER
GO
